define("torabot/main/0.1.0/search-result-debug", [ "./init-debug", "seajs/seajs-style/1.0.2/seajs-style-debug", "./ut-debug", "./moment-debug", "./moment/moment-debug", "./moment/lang/zh-cn-debug", "./pnotify.custom.min-debug", "./switch-debug", "./bootstrap-switch/bootstrap-switch-debug", "./xeditable-debug", "./xeditable/xeditable-debug", "./xeditable/xeditable-debug.css", "./search-debug", "silviomoreto-bootstrap-select-0e1b27a/bootstrap-select-debug", "./typeahead.jquery-debug" ], function(require, exports, module) {
    require("./init-debug");
    var self = {
