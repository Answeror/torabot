...
TORABOT_FOOTER_LEFT_LINKS = []
TORABOT_FOOTER_RIGHT_LINKS = []
TORABOT_REQUEST_CACHE_LIFE = 300
TORABOT_PASSWORD_RESET_LINK_LIFE = 3600
TORABOT_ACTIVATION_LINK_LIFE = 3600
...
# test
TORABOT_TEST_CONNECTION_STRING = 'postgresql+psycopg2://localhost/torabot-test'
TORABOT_TEST_CHII_AUTH = 'bangumi chii auth'
